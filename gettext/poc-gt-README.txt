...
Ruta: ./
gt_main.c         -> Usado como entrada del programa
gt_aio.c          -> All In One es ignorado por make

2. Exec files para compilar

Ruta: ./
gt_run_make lang  -> Compila con "make all" y ejecuta ./bin/
...
gt_run_gcc lang   -> Imprime contenido del idioma argumento
gt_run_aio lang   -> Análisis de memoria con valgrind
gt_gen_po         -> Extrae los _(Strings) del .c a .pot
